...
<form method="POST" action="php/eliminarVehiculoDeLaBase.php" class="input" onsubmit="return validar()">
	...
	<input type="E-mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" class="FormularioVehiculos" name="correoAlternativo" maxlength="45" placeholder="Ingrese su mail" required/>
	...
	<br><br>
	<label class="LabelFormularios"> Enviaremos la nueva contraseña a su mail alternativo </label>
	<br><br>
